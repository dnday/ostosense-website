...
const alertVariants = cva('flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)', {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      appearance: 'light',
      className:
        'bg-blue-50 border border-blue-100 text-blue-900 [&_[data-slot=alert-icon]]:text-blue-600',
    },
    {
      variant: 'destructive',
      appearance: 'light',
      className:
        'bg-red-50 border border-red-100 text-red-900 [&_[data-slot=alert-icon]]:text-red-600',
    },
    {
      variant: 'success',
      appearance: 'light',
      className:
        'bg-green-50 border border-green-200 text-green-900 [&_[data-slot=alert-icon]]:text-green-600',
    },
    {
      variant: 'info',
      appearance: 'light',
      className:
        'bg-violet-50 border border-violet-100 text-violet-900 [&_[data-slot=alert-icon]]:text-violet-600',
    },
    {
      variant: 'warning',
      appearance: 'light',
      className:
        'bg-yellow-50 border border-yellow-200 text-yellow-900 [&_[data-slot=alert-icon]]:text-yellow-600',
    },
